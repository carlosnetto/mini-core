...
listschemas.sh                # Lists all schemas in the database (\dn+)
listtables.sh                 # Lists tables in minicore schema (optional arg: schema name)
transfer_data_pack.sh         # Packs .env + minicore schema dump into ~/mini-core-transfer-TIMESTAMP.tar.gz
unpack.sh                     # Restores .env and schema dump on target machine
scripts/
  db-update.sh                # Runs Liquibase via docker run (no docker-compose needed); --seed flag to include seed data
docs/
