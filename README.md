...
The ER diagram is auto-generated by [SchemaSpy](https://schemaspy.org/) on every `docker-compose up` and committed to the repo:

![ER Diagram](docs/erd/diagrams/summary/relationships.real.large.png)

Full interactive HTML documentation is in `docs/erd/index.html`.
